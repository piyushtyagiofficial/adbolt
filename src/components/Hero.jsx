...
const Hero = ({ onBookNowClick }) => {
  return (
    <section className="pt-24 pb-16 bg-gradient-to-br from-dark-900 via-dark-800 to-primary-900">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
              Grow Your Business with<br />
              <span className="text-accent-400">Result-Driven</span><br />
            ...
            <div className="bg-dark-800 border border-dark-700 p-6 rounded-lg shadow-lg mb-8 max-w-4xl mx-auto border-l-4 border-accent-500">
              <div className="flex items-center justify-center mb-4">
                <ArrowRight className="w-6 h-6 text-accent-400 mr-2" />
            ...
            <button
              ...
              className="bg-accent-600 hover:bg-accent-700 text-white text-xl px-8 py-4 rounded-lg transition-all transform hover:scale-105 shadow-lg mb-12 inline-flex items-center"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center bg-dark-800 border border-dark-700 p-6 rounded-lg shadow-md">
